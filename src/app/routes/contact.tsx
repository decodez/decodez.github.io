  ...
  return (
    <div className="container mx-auto px-4 py-16 sm:px-8 transition-colors duration-500">
      <div className="mx-auto max-w-2xl text-center">
        <h1 className="mb-6 text-4xl font-bold text-[var(--text-primary)]">Get in Touch</h1>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="text-sm text-[var(--text-secondary)]">hello@akhil.dev</p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-[var(--text-secondary)]">Connect with me</p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-[var(--text-secondary)]">Check out my code</p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-[var(--text-secondary)]">Download PDF</p>
          </a>
        </div>
